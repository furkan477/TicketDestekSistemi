...
<div class="site-wrap main-header">
    <div class="site-section">
        <div class="container-fluid">
            <h1 class="text-center">Askıda Olan Destek Talebleriniz </h1><br><br><br>
            <div class="card bg-dark" style="color:red;">
                ...
                <div class="card-footer clearfix">
                    <a href="{{route('admin.destek.active')}}" class="btn btn-sm btn-success float-left">Devam Eden Destekler</a>
                ...
                @if(!empty($supports) && $supports->count() == 0)
                <h1 class="text-center" style="color:red;">Askıya Alınmış Destek Talebiniz Bulunamamaktadır ! <i class="fa-solid fa-triangle-exclamation"></i></h1>
                @endif
            </div>
        </div>
    </div>
