...
<div class="site-wrap main-header">
    <div class="site-section">
        <div class="container-fluid">
            <h1 class="text-center">Devam Eden Destek Talebleriniz </h1><br><br><br>
            @if ($errors)
                ...
                @endif
            <div class="card bg-dark" style="color:red;">
                        ...
                        <table class="table m-0">
                            ...
                            <tbody>
                                ...
                                <tr style="color:red;">
                                    ...
                                    <td>
                                        <div class="sparkbar" data-color="#00a65a" data-height="20">{{$sp->created_at}}</div>
                                    </td>
                                    <td>{{$sp->subject}}</td>
                ...
                <div class="card-footer clearfix">
                    <a href="{{route('admin.destek.hanger')}}" class="btn btn-sm btn-warning float-left">Askıya Alınan Destekler</a>
                    <a href="{{route('admin.destek.terminated')}}" class="btn btn-sm btn-danger float-left" style="margin-left: 0.3%;">Sonlandırılmış Destekler</a>
                </div>
                @if(!empty($supports) && $supports->count() == 0)
                <h1 class="text-center" style="color:red;">Açık Destek Talebiniz Bulunamamaktadır ! <i class="fa-solid fa-triangle-exclamation"></i></h1>
                @endif
            </div>
        </div>
    </div>
