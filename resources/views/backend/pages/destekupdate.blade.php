        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    @endif
                    <form action="{{route('admin.destek.update',$support->id)}}" method="post">
                        @csrf
                        <div class="p-3 p-lg-5 border">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="c_lname" class="text-black">Ad Soyad <span class="text-danger">*</span></label>
                                    <input type="text" disabled class="form-control" value="{{$support->user->name}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="c_lname" class="text-black">E-Posta <span class="text-danger">*</span></label>
                                    <input type="text" disabled class="form-control" value="{{$support->user->email}}">
                                </div>
                            </div>  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select type="submit" name="status" class="form-control" value="{{ $support->status }}">
                                        ...
                                        <option value="Askıda" {{ $support->status == 'Askıda' ? 'selected' : '' }}>Askıya Al</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
