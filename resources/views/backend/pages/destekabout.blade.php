    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <div class="row" style="margin-left: 15.0%;">
                    <div class="col-12">
                ...
                <div class="row" style="margin-left: 7.3%;">
                    <div class="col-10">
                        <div class="invoice p-3 mb-3">
                            @if(!empty($message) && $message->count() > 0)
                                @foreach($message as $usrmsg)
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>
                                            <i class="fa-solid fa-user"></i> Müşteri : {{ $usrmsg->user->name }}<p class="text-right">gönderilme tarihi : {{$usrmsg->created_at}}</p>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <textarea disabled name="message" cols="190" rows="3">{{$usrmsg->message}}</textarea>
                                        </div>
                                    </div><br>
                ...
                <div class="row" style="margin-left: 8.0%;">
                    @if ($errors)
                    ...
                    @endif
                    <form action="{{route('admin.destek.about.message',$support->id)}}" method="post">   
                        @csrf
                        <div class="col-10">
                            <div class="invoice p-3 mb-3">
                                <div class="row">
                                    <div class="col-12">
                                        <h4>
                                        <i class="fa-solid fa-user"></i> Müşteri Yönetim Sistemi : 
                                        </h4>
                                    </div>
                                </div><br>
                                <div class="row invoice-info">
                                    <div class="row">
                                        <label for="" style="margin-left: 1.0%;">Mesaj Gönder</label>
                                        <div class="col-12">
                                            <textarea name="message" cols="190" rows="3"></textarea>
                                        </div>
                                        <div class="col-10"><br>
                    ...
                    <form action="{{route('admin.destek.status',$support->id)}}" method="post">
                        @csrf
                        <button type="submit" class="btn btn-danger btn-sm col-12" style="margin-left: 10.0%;">Desteği Sonlandır.</button>
                    </form>
                </div>
            </div>
        </section>
