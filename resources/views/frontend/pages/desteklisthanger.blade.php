        ...
        <div class="container-fluid">
            ...
            <div class="card bg-dark">
                ...
                <div class="card-footer clearfix">
                    ...
                    <a href="{{route('destek.list.son')}}" class="btn btn-sm btn-danger float-left" style="margin-left: 0.3%;">Sonlandırılmış Desteklerim</a>
                </div>
                @if(!empty($support) && $support->count() == 0)
                <h1 class="text-center">Askıya Alınmış Destek Talebiniz Bulunamamaktadır ! <i class="fa-solid fa-triangle-exclamation"></i></h1>
                @endif
            </div>
        </div>
    </div>
