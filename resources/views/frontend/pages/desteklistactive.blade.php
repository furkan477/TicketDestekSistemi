        ...
        <div class="container-fluid">
            ...
            <div class="card bg-dark">
                ...
                <div class="card-footer clearfix">
                    ...
                    <a href="{{route('destek.list.askı')}}" class="btn btn-sm btn-warning float-left" style="margin-left: 0.3%;">Askıya Alınan Desteklerim</a>
                </div>
                @if(!empty($support) && $support->count() == 0)
                <h1 class="text-center">Açık Destek Talebiniz Bulunamamaktadır ! <i class="fa-solid fa-triangle-exclamation"></i></h1>
                @endif
            </div>
        </div>
    </div>
